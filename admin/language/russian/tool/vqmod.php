...
$_['entry_vqm_backup']		= 'vQMods XML Backup Folder:<span class="help">Set or change XML Backup folder<br/>(use "../vqmod/FOLDER/" or just "FOLDER/")</span>';
...
$_['entry_show_trim']		= 'Show Trim:<span class="help">Show trim checkboxes?</span>';
$_['entry_show_regex']		= 'Show Regex:<span class="help">Show Regex checkboxes?</span>';
$_['entry_show_info']		= 'Show Info:<span class="help">Show information text fields?</span>';
$_['entry_search_delay']	= 'Check Search:<span class="help">Set Timeout to look for the search string.<br/>0 will not search</span>';
...
$_['error_vqmod_write']		= 'Warning: Could not write vQMod files! Please check the vQMod folder permissions and ownership.<br/>';
$_['error_update_server']	= 'Warning: vQModerator update-server not available! Please <a href="http://www.vqmoderator.com/" target="_blank">update vQModerator manually.</a><br/>';
$_['error_update_write']	= 'Warning: Could not write vQModerator files! Please check your admin folder permissions and ownership.<br/>';
